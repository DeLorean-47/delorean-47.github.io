    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a1 = element("a");
    			img2 = element("img");
    			attr_dev(img0, "class", "picture svelte-vnuyzh");
    			...
    			attr_dev(div0, "class", "imgWrapper svelte-vnuyzh");
    			...
    			attr_dev(p1, "class", "bio svelte-vnuyzh");
    			add_location(p1, file$1, 21, 6, 562);
    			attr_dev(img1, "class", "logo svelte-vnuyzh");
    			...
    			attr_dev(img2, "class", "logo svelte-vnuyzh");
    			...
    			attr_dev(div1, "class", "memberLogos svelte-vnuyzh");
    			add_location(div1, file$1, 22, 6, 593);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file$1, 18, 4, 465);
    			attr_dev(div3, "class", "card svelte-vnuyzh");
    			add_location(div3, file$1, 14, 2, 286);
    			attr_dev(div4, "class", "column svelte-vnuyzh");
    ...
    function create_if_block_9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "svelte-14s1i0t");
    			add_location(a0, file, 92, 4, 3049);
    			attr_dev(div, "class", "oslabs svelte-14s1i0t");
    			add_location(div, file, 91, 2, 3024);
    			attr_dev(img1, "id", "logo");
    			attr_dev(img1, "class", "center svelte-14s1i0t");
    			...
    			attr_dev(img2, "class", "center svelte-14s1i0t");
    			...
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "class", "svelte-14s1i0t");
    ...
    function create_if_block_8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "svelte-14s1i0t");
    			...
    			attr_dev(span1, "class", "svelte-14s1i0t");
    			add_location(span1, file, 106, 96, 3785);
    			add_location(p, file, 106, 4, 3693);
    			attr_dev(div, "class", "mainContainer svelte-14s1i0t");
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "whiteText svelte-14s1i0t");
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "gifPlaceholder svelte-14s1i0t");
    			add_location(div, file, 121, 8, 4750);
    			attr_dev(span1, "class", "featureText svelte-14s1i0t");
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			if_block.c();
    			attr_dev(span, "class", "featureText svelte-14s1i0t");
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "gifPlaceholder svelte-14s1i0t");
    			add_location(div0, file, 132, 32, 5657);
    			attr_dev(div1, "class", "gifRight svelte-14s1i0t");
    			...
    			attr_dev(p, "class", "feat featRight svelte-14s1i0t");
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span2, "class", "featureText svelte-14s1i0t");
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(strong0, "class", "svelte-14s1i0t");
    			...
    			attr_dev(a, "class", "svelte-14s1i0t");
    			...
    			attr_dev(strong1, "class", "svelte-14s1i0t");
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "row svelte-14s1i0t");
    			add_location(div0, file, 171, 4, 8436);
    			attr_dev(div1, "id", "teamMembers");
    			attr_dev(div1, "class", "whiteText teamMembers svelte-14s1i0t");
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(footer, "class", "svelte-14s1i0t");
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-14s1i0t");
